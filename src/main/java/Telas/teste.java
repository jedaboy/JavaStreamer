...
public class teste extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(chewbacca, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 790, -1, 20));

        CadastroLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/button.png"))); // NOI18N
        ...
        jPanel1.add(CadastroLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 786, -1, 30));

        loginLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/button.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Tela_login.png"))); // NOI18N
    ...
    private void loginLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginLabelMouseClicked
        ...
        Usuario usuario = new Usuario(nome, senha,logou);
        try {
            usuario = usuarioDao.login(usuario,logou);
        } catch (Exception ex) {
            Logger.getLogger(teste.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(usuario.getLogou()){
    ...
    private void loginLabelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginLabelMouseEntered
        loginLabel.setIcon(new ImageIcon(getClass().getResource("/pressbutton.png")));
    ...
    private void loginLabelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginLabelMouseExited
        loginLabel.setIcon(new ImageIcon(getClass().getResource("/button.png")));
    ...
    private void CadastroLabelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CadastroLabelMouseEntered
        CadastroLabel.setIcon(new ImageIcon(getClass().getResource("/pressbutton.png")));
    ...
    private void CadastroLabelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CadastroLabelMouseExited
        CadastroLabel.setIcon(new ImageIcon(getClass().getResource("/button.png")));
