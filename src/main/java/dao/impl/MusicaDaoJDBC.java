...
public class MusicaDaoJDBC implements MusicaDao {
    ...
    public List<Musica> listarMusicas() {
        ...
        try {
            ...
            throw new DbException("Ocorreu um erro na busca das musicas!");
        } finally {
    ...
    public List<Musica> recomendacoes(Usuario usuario) {
        ...
        try {
            ...
            //modificado pois não exibia as musicas do primeiro genero favorito
            boolean a = true;
    ...
    private Musica instantiateMusica(ResultSet rs) throws SQLException {
        ...
        try {
            ...
            while (rs1.next()) {
                GeneroDao generoDao = DaoFactory.createGeneroDao();
                Genero genero = generoDao.getGeneroById(rs1.getInt("id_genero"));
                generos.add(genero);
            }
